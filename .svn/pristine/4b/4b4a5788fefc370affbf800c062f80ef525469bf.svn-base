...
id=k[i].value;
  ...
  if(j==0)
  alert("不能批量确认，请至少选择一项！")
  else if( document.getElementById("pltdh").value!=""){
 document.getElementById("form1").action="list.htm?action=chktdh&flag=qr";
...
id=k[i].value;
 ...
 document.getElementById("form1").action="list.htm?action=chktdh&flag=qx";
 document.getElementById("form1").submit(); 
 }
 }
</SCRIPT>
...
<div align="right"><IMG src="images\close.gif" alt="点击关闭层" width="13" height="13" style="cursor:hand" onclick="MM_showHideLayers('showdiv','','hide')">
 ...
 <form id="form1" method="post" action="list.htm?action=chktdh">
...
<td width="10" align="center" class="main_menu_left">&nbsp;</td><td valign="top" style="padding-right:5px;"><table class="table_1"  width="100%"><tr><td background="images/menu_bg.png" style="color:#3965b5;height:20px;font-weight: bold;border-bottom:1px solid #D1DAE6;">&nbsp;&nbsp;批量提单号指定</td></tr> <tr><td  style="padding:5px;"><fieldset style="width:100%;height:60px;border: 1 solid #3e7fd9"  ><legend>查询条件</legend>
...
<td>箱型:</td><td><input type="text" class="text" id="xx" name="xx" onkeyup="kd('xx')" autocomplete="off" value="${jc.xx }"/></td><td rowspan="10"><input type="button" onclick="mysu()" class="btn_2k3" value="查询"></td></tr>
...
<DIV id="nseer_grid_div"  align="right"><table><tr><td><input type="input" class="text" style="vertical-align:top" id="pltdh" name="pltdh"   autocomplete="off"  >&nbsp;&nbsp;<input type="button" onclick="plqr()" value="批量提单号确认"  onmouseover=this.className='btn3_mouseover' onmouseout=this.className='btn3_mouseout' onmousedown=this.className='btn3_mousedown' onmouseup=this.className='btn3_mouseup' class="SUBMIT_STYLE1">&nbsp;&nbsp;<input type="button" class="btn_2k3" onclick="plqx()" value="批量提单号取消"></td></tr></table></DIV>
