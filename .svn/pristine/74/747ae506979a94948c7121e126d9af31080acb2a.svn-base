...
<div id="showdiv" style="position:absolute; width:380px; height:250px; z-index:1; left: 160px; top: 180px; visibility: hidden;">
...
</td><td><form:input path="shdm" cssClass="text" onfocus="this.select()" onkeyup="kd('shdm')"   autocomplete="off" />&nbsp;<font color="red">*</font></td>

<td align="left"   height="25">损坏位置: 
</td><td>
<form:input path="shwz"  cssClass="text" onfocus="this.select()" onkeyup="kd('shwz')"   autocomplete="off" /></td>


</tr><tr>
<td >&nbsp;&nbsp;损坏描述:</td><td><form:input path="shmx" cssClass="text_3" onkeydown="tabs()" /></td>
<td >数量:</td><td><form:input path="sl" cssClass="text" onkeydown="tabs()" onblur="cul()" onfocus="this.select()" /></td>
<td>小时:</td><td><form:input path="xs" cssClass="text" onkeydown="tabs()" onblur="cu2()"  onfocus="this.select()" /></td>

</tr>

<tr>
<td>&nbsp;&nbsp;工时费:</td><td><form:input path="gsf" cssClass="text" onkeydown="tabs()"  onfocus="this.select()" /></td>
<td>材料费:</td><td><form:input path="clf" onkeydown="tabs()"   onfocus="this.select()" cssClass="text"/></td>
<td>付费方:</td><td><form:select path="fff" cssClass="combobox" onkeydown="tabs()"><form:option value="C" label="C"/><form:option value="U" label="U"/><form:option value="O" label="O"/><form:option value="W" label="W"/></form:select></td>
 </tr>
