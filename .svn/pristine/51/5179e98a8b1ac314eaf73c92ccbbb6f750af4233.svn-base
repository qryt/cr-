...
{ id : 'cz'      , header : "操作" , width : 50 },
		{ id : 'xxl'      , header : "箱型类" , width : 100 },
		{ id : 'mx'      , header : "描叙" , width : 300} 
];
...
<td width="10" align="center" class="main_menu_left">&nbsp;</td><td valign="top"  style="padding-right:5px"><table class="table_1"  ><tr><td background="images/menu_bg.png" style="color:#3965b5;height:20px;font-weight: bold;border-bottom:1px solid #D1DAE6;">&nbsp;&nbsp;添加箱型信息</td></tr><tr><td height=10></td></tr><tr><td style="padding:5px;"><fieldset style="width:100%;height:60px;border: 1 solid #3e7fd9;" ><legend>箱型信息</legend>
<form:form >
<table width="800" cellpadding="0" cellspacing="0" border="0" >
<tr><td align="left"   height="25">&nbsp;&nbsp;箱型类:
</td><td width="150"><form:input path="xxl" cssClass="text" onfocus="this.select()" onkeydown="tabs()"   autocomplete="off" />&nbsp;<font color="red">*</font></td>
<td >描叙:</td><td><form:input path="mx" cssClass="text_2" onkeydown="tabs()" /></td>
 
</tr>

<tr><td height="10"></td></tr>
<tr><td colspan="8" style="color:red" align="center">&nbsp;<form:errors path="*"></form:errors></td></tr>
<tr ><td style="padding:5px;" colspan="8" align="center"><input type="button" name="tj" class="btn_2k3" value="添加" onfocus="document.getElementById('command').submit()">&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>
