...
<script language="JavaScript" src="js/calendar_month.js" type="text/JavaScript"></script>
  ...
  <body onload="MM_dragLayer('showdiv','',0,0,0,0,true,false,-1,-1,-1,-1,false,false,0,'',false,'');document.getElementById('shdm').focus()">
...
<tr><td align="left"   height="25">&nbsp;&nbsp;损坏代码: 
</td><td><form:input path="shdm" cssClass="text" onfocus="this.select()" onkeydown="tabs()" autocomplete="off" />&nbsp; </td>
<td >损坏描叙:</td><td><form:input path="shmx" cssClass="text" onkeydown="tabs()" /></td>
</tr><tr><td>工时:</td><td><form:input path="gs" cssClass="text" onkeydown="tabs()" onfocus="this.select()" /></td>
