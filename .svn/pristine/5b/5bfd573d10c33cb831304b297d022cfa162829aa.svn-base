...
var colsConfig = [
{ id : 'cz'      , header : "操作" , width : 150 },
		{ id : 'zh'      , header : "帐号" , width : 100 },
		{ id : 'xm'      , header : "姓名" , width : 100},  
		{ id : 'jsmc'      , header : "角色名称" , width : 200},  
		{ id : 'qxfw'      , header : "权限范围" , width : 200}
];
...
document.getElementById("showdiv").style.left=300;
document.getElementById("showdiv").style.visibility="visible";
}
function showqx(){
	document.getElementById("fid").src="list.htm?action=listqx&id=<%=request.getParameter("bh")%>";
	document.getElementById("showdiv").style.left=750;
	document.getElementById("showdiv").style.visibility="visible";
	}
</script>
  </head>
...
<div id="showdiv" style="position:absolute; width:160px; height:250px; z-index:1; left: 710px; top: 160px; visibility: hidden;">
...
<div align="right"><IMG src="images\close.gif" alt="点击关闭层" width="13" height="13" style="cursor:hand" onclick="MM_showHideLayers('showdiv','','hide')">
      ...
      <tr>
        <td bgcolor="#FFFFFF"><iframe  width="100%" height="280" scrolling="auto" frameborder="1" id="fid" name="fid" src="about:blank"></iframe></td>
      </tr>
    </table>
  </div>
</div>
...
<td width="10" align="center" class="main_menu_left">&nbsp;</td><td valign="top"  style="padding-right:5px"><table class="table_1"  ><tr><td background="images/menu_bg.png" style="color:#3965b5;height:20px;font-weight: bold;border-bottom:1px solid #D1DAE6;">&nbsp;&nbsp;添加用户信息</td></tr><tr><td height=10></td></tr><tr><td style="padding:5px;"><fieldset style="width:100%;height:60px;border: 1 solid #3e7fd9;" ><legend>用户信息</legend>
<form:form >
<table width="800" cellpadding="0" cellspacing="0" border="0" >
<tr><td align="left"   height="25">&nbsp;&nbsp;帐号:
</td><td><form:input path="zh" cssClass="text" onfocus="this.select()" onkeydown="tabs()"   autocomplete="off" />&nbsp;<font color="red">*</font></td><td >姓名:</td><td><form:input path="xm" cssClass="text" onkeydown="tabs()" /></td>
<td>密码:</td><td><form:input path="mm" cssClass="text"  onkeydown="tabs()" /></td>
</tr>

<tr>
<td>角色名称:</td><td colspan="3"><form:input path="jsmc" readonly="true"  />&nbsp;<input type="button" class="btn_2k3" onclick="showjs()" value="添加角色"> </td>
<td>权限范围:</td><td colspan="3"><form:input path="qxfw" readonly="true"  />&nbsp;<input type="button" class="btn_2k3" onclick="showqx()" value="添加范围"> </td>
</tr>
<tr>
</tr>
...
<tr><td style="width:100%;overflow:hidden;">
  <div  onclick=" resizeme()" id="divme" style="width:100%;height:350px;overflow:auto">
<div id="grid1_container" style="width:100%;height:350px;overflow:auto">
</div> </div>
</td></tr>
</table></td></tr>
</table>
