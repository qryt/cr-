...
public class PrintXlfl extends HttpServlet {
...
labelC = new jxl.write.Label(0, 1, "序号", title4);
	    ...
	    labelC = new jxl.write.Label(1, 1, "损坏代码", title4);
	    
	    ws.addCell(labelC);
	    ws.setColumnView(1, 15);
	    labelC = new jxl.write.Label(2, 1, "损坏描叙", title4);
	    ws.addCell(labelC);
	    ws.setColumnView(2, 30);
	    labelC = new jxl.write.Label(3, 1, "工时", title4);
	    ws.addCell(labelC);
	    ws.setColumnView(3, 10);
	    labelC = new jxl.write.Label(4, 1, "材料费", title4);
	    ws.addCell(labelC);
	  ...
	  List list=  myService.listXlflByGsid(gsid);
	 ...
	 for(;it.hasNext();){
        ...
        ws.addCell(labelC); 
	      labelC = new jxl.write.Label(1, 1 + i, String.valueOf(map.get("shdm")), title4);
        ws.addCell(labelC); 
	      labelC = new jxl.write.Label(2, 1 + i, String.valueOf(map.get("shmx")), title4);
        ws.addCell(labelC); 
        labelNF = new jxl.write.Number(3, 1 + i, Double.parseDouble(String.valueOf(map.get("gs"))), wcfN);
        ws.addCell(labelNF);
        labelNF = new jxl.write.Number(4, 1 + i, Double.parseDouble(String.valueOf(map.get("clf"))), wcfN);
        ws.addCell(labelNF);
	 ...
	 ++i;
	 ++i;
	 labelC = new jxl.write.Label(3, 1 + i,  "货币类型：", title4);
     ws.addCell(labelC); 
     labelC = new jxl.write.Label(4, 1 + i,  cgs.getHblx(), title4);
     ws.addCell(labelC); 
     ++i;
     labelC = new jxl.write.Label(3, 1 + i, "修理费率：", title4);
     ws.addCell(labelC); 
     labelNF = new jxl.write.Number(4, 1 + i, cgs.getGsfl(), wcfN);
     ws.addCell(labelNF);
	 wwb.write();
	    wwb.close();
	    os.close();
