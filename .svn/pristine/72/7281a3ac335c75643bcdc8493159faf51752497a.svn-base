...
<script language="JavaScript" src="js/calendar_month.js" type="text/JavaScript"></script>
  ...
  <body onload="MM_dragLayer('showdiv','',0,0,0,0,true,false,-1,-1,-1,-1,false,false,0,'',false,'');document.getElementById('shlxmc').focus()">
...
<table class="table_1"  ><tr><td background="images/menu_bg.png" style="color:#3965b5;height:20px;font-weight: bold;border-bottom:1px solid #D1DAE6;">&nbsp;&nbsp;修改损坏类型信息</td></tr><tr><td height=10></td></tr><tr><td style="padding:5px;"><fieldset style="width:100%;height:60px;border: 1 solid #3e7fd9;" ><legend>损坏类型信息</legend>
<form:form >
<table width="100%" cellpadding="0" cellspacing="0" border="0" >
<tr><td align="left"   height="25">&nbsp;&nbsp;损坏类型代码: 
</td><td><form:input path="shlxdm" cssClass="text_readonly" readonly="true"  onfocus="this.select()"   onkeydown="tabs()" autocomplete="off" />&nbsp;<font color="red">*</font></td>
<td >损坏类型名称:</td><td><form:input path="shlxmc" onfocus="this.select()" cssClass="text" onkeydown="tabs()" /></td>
</tr><tr><td>损坏类型描叙:</td><td colspan="3"><form:input path="shlxmx" cssClass="text_2"   onkeydown="tabs()" onfocus="this.select()" /></td>
</tr>
