...
<script language="JavaScript" src="js/calendar_month.js" type="text/JavaScript"></script>
  ...
  <body onload="MM_dragLayer('showdiv','',0,0,0,0,true,false,-1,-1,-1,-1,false,false,0,'',false,'');document.getElementById('lx').focus()">
...
<table class="table_1"  ><tr><td background="images/menu_bg.png" style="color:#3965b5;height:20px;font-weight: bold;border-bottom:1px solid #D1DAE6;">&nbsp;&nbsp;修改修理费率信息</td></tr><tr><td height=10></td></tr><tr><td style="padding:5px;"><fieldset style="width:100%;height:60px;border: 1 solid #3e7fd9;" ><legend>修理费率2</legend>
<form:form >
<table width="100%" cellpadding="0" cellspacing="0" border="0" >
<tr><td align="left"   height="25">&nbsp;&nbsp;类型: 
</td><td><form:input path="lx" cssClass="text" onfocus="this.select()" onkeydown="tabs()" autocomplete="off" />&nbsp; </td>
<td >部件名称:</td><td><form:input path="bjmc" cssClass="text" onkeydown="tabs()" /></td>
</tr>
<tr><td align="left"   height="25">&nbsp;&nbsp;修理方法: 
</td><td><form:input path="xlff" cssClass="text" onfocus="this.select()" onkeydown="tabs()" autocomplete="off" />&nbsp; </td>
<td >长:</td><td><form:input path="c" cssClass="text" onkeydown="tabs()" /></td>
</tr>
<tr><td align="left"   height="25">&nbsp;&nbsp;宽: 
</td><td><form:input path="k" cssClass="text" onfocus="this.select()" onkeydown="tabs()" autocomplete="off" />&nbsp; </td>
<td >修理描叙:</td><td><form:input path="xlmx" cssClass="text" onkeydown="tabs()" /></td>
</tr>
<tr><td>&nbsp;&nbsp;工时:</td><td><form:input path="gs" cssClass="text" onkeydown="tabs()" onfocus="this.select()" /></td>
<td>材料费:</td><td><form:input path="clf" cssClass="text" onkeydown="tabs()"  onfocus="this.select()" /></td></tr>
