...
{ id : 'cz'      , header : "操作" , width : 50 },
		{ id : 'RName'      , header : "角色名称" , width : 100 },
		{ id : 'RCaption'      , header : "角色标题" , width : 100},
		{ id : 'RDescription'      , header : "角色描叙" , width : 300}  
];
...
<td width="10" align="center" class="main_menu_left">&nbsp;</td><td valign="top"  style="padding-right:5px"><table class="table_1"  ><tr><td background="images/menu_bg.png" style="color:#3965b5;height:20px;font-weight: bold;border-bottom:1px solid #D1DAE6;">&nbsp;&nbsp;添加角色信息</td></tr><tr><td height=10></td></tr><tr><td style="padding:5px;"><fieldset style="width:100%;height:60px;border: 1 solid #3e7fd9;" ><legend>角色信息</legend>
<form:form >
<table width="800" cellpadding="0" cellspacing="0" border="0" >
<tr><td align="left"   height="25">&nbsp;&nbsp;角色名称:
</td><td><form:input path="RName" cssClass="text" onfocus="this.select()" onkeydown="tabs()"   autocomplete="off" />&nbsp;<font color="red">*</font></td><td >角色标题:</td><td><form:input path="RCaption" cssClass="text" onkeydown="tabs()" /></td><td>角色描叙:</td><td><form:input path="RDescription" cssClass="text_2"  onkeydown="tabs()" /></td>
</tr>
