...
{ id : 'cz'      , header : "操作" , width : 50 },
		{ id : 'xxdm'      , header : "箱型代码" , width : 100 },
		{ id : 'xxmc'      , header : "箱型名称" , width : 100},
		{ id : 'xxmx'      , header : "箱型描述" , width : 200} 
];
...
</td><td><form:input path="xxdm" cssClass="text" onfocus="this.select()" onkeydown="tabs()"   autocomplete="off" />&nbsp;<font color="red">*</font></td><td >箱型名称:</td><td><form:input path="xxmc" cssClass="text" onkeydown="tabs()" /></td><td>箱型描叙:</td><td><form:input path="xxmx" cssClass="text_2"  onkeydown="tabs()" /></td>
</tr>
