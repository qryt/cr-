...
var rowData=new Array(
		'<input type="text" size="3" name="shlx" id="shlx"   autocomplete="off"   onBlur="mysum()" onFocus="this.select()" onKeyup="mykd(document.getElementById(\'cgs\').value,parentElement.parentElement.rowIndex,this)" value="">',
'<input type="hidden" name="xsl" id="xsl" value="0"><input type="hidden" name="gsfl" id="gsfl" value="0"><input type="hidden" name="clfl" id="clfl" value="0"><input type="text" size="3" name="shdm"  autocomplete="off" onFocus="this.select()" onBlur="mysum()"  onKeyup="mykd(document.getElementById(\'cgs\').value,parentElement.parentElement.rowIndex,this)"  id="shdm" value="">',
'<input type="text" size="3" name="shwz" id="shwz"   autocomplete="off"  onkeydown="tabs()"   onBlur="mysum()"  onFocus="this.select()" onKeyup="mykd(document.getElementById(\'cgs\').value,parentElement.parentElement.rowIndex,this)" value="">',
'<input type="text" size="55" name="shmx" id="shmx"   autocomplete="off" onkeydown="tabs()"  onBlur="mysum()" onFocus="this.select()" value="">',
'<input type="text" size="4" name="sl" id="sl"   autocomplete="off" onkeydown="tabs()"  onblur="mycu1(this,parentElement.parentElement.rowIndex);mysum()" onFocus="this.select()" value="">',
'<input type="text" size="4" name="xs" id="xs"   autocomplete="off"  onkeydown="tabs()"  onBlur="mycu1(this,parentElement.parentElement.rowIndex);mysum()"  onFocus="this.select()" value="">',
'<input type="text" size="4" name="gsf" id="gsf"   autocomplete="off" onkeydown="tabs()"   onBlur="mysum()" onFocus="this.select()" value="">',
'<input type="text" size="4" name="clf" id="clf"    autocomplete="off" onkeydown="tabs()"  onBlur="mysum()" onFocus="this.select()" value="">',
'<select id="fff" name="fff" class="combobox"  onBlur="mysum()"  onkeydown="tabs()"><option value="O">O</option><option value="C">C</option><option value="U">U</option><option value="W">W</option></select>',
...
function check(){
	 var arr=document.getElementsByName("shdm");
	 var b=false;
...
<tr>
<td>&nbsp;&nbsp;船公司:</td><td><INPUT type="hidden" name="jc" id="jc" value="1" /><form:input path="cgs" onfocus="this.select()" cssClass="text" onkeyup="kd('cgs')" autocomplete="off"  />&nbsp;<font color="red">*</font></td>
...
<td>箱型:</td><td><TABLE cellpadding="0" cellspacing="0" border="0" ><tr><td><form:input path="xx" onfocus="this.select();" cssClass="text_5" onkeyup="kd('xx')" autocomplete="off" />&nbsp;</td><td><form:input path="xxl" cssClass="text_5" onfocus="this.select();" onkeydown="tabs()" autocomplete="off"  />&nbsp;<font color="red">*</font></td></tr></TABLE></td>
...
<tr><td>&nbsp;&nbsp;验箱员:</td><td><select id="yxy" name="yxy"   onkeydown="tabs()"  ><option></option></select></td><td>&nbsp;&nbsp;备注:</td><td colspan="5"><form:input path="bz" onfocus="this.select()" onkeydown="tabs()" cssClass="bz"/><div class="gray">最多可输入<span id="stat_max" class="b light"></span>，当前共<span id="stat_total" class="b light"></span>，还可输入<span id="stat_left" class="b light"></span></div> </td></tr>
...
<table   id='t1'   width="100%"  style="padding:10px"  border="1"   cellspacing="0"   cellpadding="0">   
 ...
 <td width="60">损坏类型</td>
   <td width="60">损坏代码</td> 
	    ...
	    <tr><td colspan=4><a   href="#"   onclick="addRow(this.parentNode.parentNode.rowIndex-1);mysum();return   false">add</a>&nbsp;&nbsp;</td><td align="right">合计：</td><td><font id="xshj" color="red">0.00</font></td><td><font id="gsfhj" color="red">0.00</font></td><td><font id="clfhj" color="red">0.00</font></td><td colspan="2">总计：<font id="zjhj" color="red">0.00</font></td></tr>
 
	  
<tr><td colspan="10" align="center"><font id="me2" color="red"></font>
  </table>  
</fieldset>
...
/*$.ajax({url:"list.htm",type:"post",async:false,data:"action=getyxy",
