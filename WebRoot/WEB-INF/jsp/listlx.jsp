...
function sel(a){
	var arr=a.split("|");
parent.document.getElementById("lx").value=arr[0];
parent.document.getElementById("gs").value=arr[1];
parent.document.getElementById("gsf").value=arr[2];
parent.document.getElementById("clf").value=arr[3];
parent.document.getElementById("gsfl").value=arr[4];
parent.document.getElementById("xsl").value=arr[1];
parent.document.getElementById("clfl").value=arr[3];
parent.document.getElementById("xlmx").value=arr[5];
parent.document.getElementById("sl").value="1";
 if(null!=parent.document.getElementById("sl")&&typeof(parent.document.getElementById("sl"))!="undefined")
parent.document.getElementById("sl").focus();
...
<tr bgcolor="#6595d6"><td width="20%"><font style="font-size:12px">序号</font></td><td><font style="font-size:12px">类型</font></td></tr>
