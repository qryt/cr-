...
<td width="10" align="center" class="main_menu_left">&nbsp;</td><td valign="top"  style="padding-right:5px"><table class="table_1"  ><tr><td background="images/menu_bg.png" style="color:#3965b5;height:20px;font-weight: bold;border-bottom:1px solid #D1DAE6;">&nbsp;&nbsp;添加位置代码</td></tr><tr><td height=10></td></tr><tr><td style="padding:5px;"><fieldset style="width:100%;height:60px;border: 1 solid #3e7fd9;" ><legend>位置代码</legend>
<form:form >
<table width="200" cellpadding="0" cellspacing="0" border="0" >
<tr><td align="left"   height="25" width="80">&nbsp;&nbsp;位置代码:
</td><td width="150" align="left" ><form:input path="wzdm" cssClass="text" onfocus="this.select()" onkeydown="tabs()"   autocomplete="off" />&nbsp;<font color="red">*</font></td> 
</tr>
