...
id=k[i].value;
  ...
  else if( document.getElementById("plbz").value!=""){
 document.getElementById("form1").action="list.htm?action=chkbz&flag=qr";
...
id=k[i].value;
 ...
 document.getElementById("form1").action="list.htm?action=chkbz&flag=qx";
 document.getElementById("form1").submit(); 
 }
 }
</SCRIPT>
...
<div align="right"><IMG src="images\close.gif" alt="点击关闭层" width="13" height="13" style="cursor:hand" onclick="MM_showHideLayers('showdiv','','hide')">
 ...
 <form id="form1" method="post" action="list.htm?action=chkbz">
...
<td width="10" align="center" class="main_menu_left">&nbsp;</td><td valign="top" style="padding-right:5px;"><table class="table_1"  width="100%"><tr><td background="images/menu_bg.png" style="color:#3965b5;height:20px;font-weight: bold;border-bottom:1px solid #D1DAE6;">&nbsp;&nbsp;批量班组指定</td></tr> <tr><td  style="padding:5px;"><fieldset style="width:100%;height:60px;border: 1 solid #3e7fd9"  ><legend>查询条件</legend>
...
<DIV id="nseer_grid_div"  align="right"><table><tr><td>作业班组：<select id="plbz" name="plbz" class="combobox"><option value="">请选择</option><option value="一组">一组</option><option value="二组">二组</option><option value="三组">三组</option><option value="四组">四组</option><option value="五组">五组</option><option value="六组">六组</option><option value="七组">七组</option><option value="八组">八组</option></select>&nbsp;&nbsp;<input type="button" onclick="plqr()" value="批量班组确认"  onmouseover=this.className='btn3_mouseover' onmouseout=this.className='btn3_mouseout' onmousedown=this.className='btn3_mousedown' onmouseup=this.className='btn3_mouseup' class="SUBMIT_STYLE1">&nbsp;&nbsp;<input type="button" class="btn_2k3" onclick="plqx()" value="批量班组取消"></td></tr></table></DIV>
...
nseer_grid.column_width=[40,100,80,100,100,80,120,120,80];
