	 ...
	 var selectedRows = Ext.getCmp("MenuGridPanel").selModel.selections.items;   
		   ...
		   var str="";
			...
			document.getElementById("ck").value=str;
			   for (var i = 0; i < selectedRows.length; i++) {  
			   var row = selectedRows[i]; 
			   if(row.data['cgs']!="CSCO"){
				   alert("选项中含有不是CSCO的集装箱，不能EDI导出！")
				   	return false;
				   	}
			 if(i==0)
			  document.getElementById("var").value=row.data['rcbh'];
	   ...
	   document.getElementById("form1").action="servlet/exCscoEDI";
	 document.getElementById("form1").submit();
			 }
			else
			alert("至少要选择一项！");
	 ...
	 var selectedRows = Ext.getCmp("MenuGridPanel").selModel.selections.items;   
		   ...
		   var str="";
			...
			document.getElementById("ck").value=str;
			   for (var i = 0; i < selectedRows.length; i++) {  
			   var row = selectedRows[i]; 
			   if(row.data['box_owner']!="CMA"){
				   alert("选项中含有不是CMA的集装箱，不能EDI导出！")
				   	return false;
				   	}
			 if(i==0)
			  document.getElementById("var").value=row.data['rcbh'];
	   ...
	   document.getElementById("form1").action="servlet/exCmaEDI";
	 document.getElementById("form1").submit();
			 }
			else
			alert("至少要选择一项！");
	 ...
	 var selectedRows = Ext.getCmp("MenuGridPanel").selModel.selections.items;   
		   ...
		   var str="";
			...
			document.getElementById("ck").value=str;
			   for (var i = 0; i < selectedRows.length; i++) {  
			   var row = selectedRows[i]; 
			   if(row.data['box_owner']!="SUN"){
				   alert("选项中含有不是SUN的集装箱，不能EDI导出！")
				   	return false;
				   	}
			 if(i==0)
			  document.getElementById("var").value=row.data['rcbh'];
	   ...
	   document.getElementById("form1").action="servlet/exSunEDI";
	 document.getElementById("form1").submit();
			 }
			else
			alert("至少要选择一项！");
	 ...
	 var selectedRows = Ext.getCmp("MenuGridPanel").selModel.selections.items;   
		   ...
		   var str="";
			...
			document.getElementById("ck").value=str;
			   ...
			   var row = selectedRows[i]; 
			   if(row.data['cgs']!="COS"){
				   alert("选项中含有不是COS箱公司的集装箱，不能EDI导出！")
				   	return false;
				   	}
			 if(i==0)
			  document.getElementById("var").value=row.data['rcbh'];
	   ...
	   document.getElementById("form1").action="servlet/exCosEDI";
	 document.getElementById("form1").submit();
			 }
			else
			alert("至少要选择一项！");
...
Ext.onReady(function(){
	...
	var dsPQ=new Ext.data.JsonStore({ 
        ...
        {value:'edirq',text:'EDI发送日期',type:'date'},
   ...
   var grid = new Ext.grid.GridPanel({
       ...
       columns: [new Ext.grid.RowNumberer({width: 30}),sm,
            ...
            {header:'箱主',dataIndex:'box_owner',width:70,sortable:true}, 
         	...
         	{header:'进场日期',dataIndex:'jcrq',width:83,sortable:true}, 
         	{header:'发送日期',dataIndex:'fsrq',width:83,sortable:true}, 
         	{header:'EDI发送日期',dataIndex:'edirq',width:83,sortable:true}, 
         	{header:'确认日期',dataIndex:'qrrq',width:83,sortable:true}, 
         	{header:'完工日期',dataIndex:'wgrq',width:83,sortable:true}, 
         	{header:'出场日期',dataIndex:'ccrq',width:83,sortable:true}, 
         	{header:'结账日期',dataIndex:'jzrq',width:83,sortable:true},
