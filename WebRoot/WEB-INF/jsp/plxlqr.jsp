...
id=k[i].value;
  ...
  else if( document.getElementById("plqrrq").value!=""){
 document.getElementById("form1").action="list.htm?action=chkqr&flag=qr";
...
id=k[i].value;
 ...
 document.getElementById("form1").action="list.htm?action=chkqr&flag=qx";
 document.getElementById("form1").submit(); 
 }
 }
...
<div align="right"><IMG src="images\close.gif" alt="点击关闭层" width="13" height="13" style="cursor:hand" onclick="MM_showHideLayers('showdiv','','hide')">
 ...
 <form id="form1" method="post" action="list.htm?action=chkqr">
...
<td width="10" align="center" class="main_menu_left">&nbsp;</td><td valign="top" style="padding-right:5px;"><table class="table_1"  width="100%"><tr><td background="images/menu_bg.png" style="color:#3965b5;height:20px;font-weight: bold;border-bottom:1px solid #D1DAE6;">&nbsp;&nbsp;批量修理确认</td></tr> <tr><td  style="padding:5px;"><fieldset style="width:100%;height:60px;border: 1 solid #3e7fd9"  ><legend>查询条件</legend>
<table  width="100%" cellpadding="0" cellspacing="0" border="0">
<tr><td align="left"   height="25">&nbsp;&nbsp;船公司:
</td><td><input type="text" class="text" id="cgs" name="cgs"  onkeyup="kd('cgs')" autocomplete="off"  value="${jc.cgs }"/></td><td >箱&nbsp;&nbsp;&nbsp;&nbsp;号:</td><td><input type="text" class="text" id="xh" onkeyup="kd('xh')" autocomplete="off" name="xh" value="${jc.xh }"/></td><td>尺寸:</td><td><select id="cc" name="cc" class="combobox"><option value="">全部</option><option value="20’">20’</option><option value="40’">40’</option><option value="45’">45’</option></select></td>
<td>箱型:</td><td><input type="text" class="text" onkeyup="kd('xx')" autocomplete="off" id="xx" name="xx" value="${jc.xx }"/></td><td rowspan="10"><input type="button" onclick="mysu()" id="cx" class="btn_2k3" value="查询"></td></tr>
...
<DIV id="nseer_grid_div"  align="right"><table><tr><td><input type="input" class="text" style="vertical-align:top" id="plqrrq" name="plqrrq" ondblclick="popUpCalendar(this, this, 'yyyy-mm-dd')" autocomplete="off"  >&nbsp;&nbsp;<input type="button" onclick="plqr()" value="批量修理确认"  onmouseover=this.className='btn3_mouseover' onmouseout=this.className='btn3_mouseout' onmousedown=this.className='btn3_mousedown' onmouseup=this.className='btn3_mouseup' class="SUBMIT_STYLE1">&nbsp;&nbsp;<input type="button" class="btn_2k3" onclick="plqx()" value="批量取消确认"></td></tr></table></DIV>
...
nseer_grid.column_width=[40,130,80,100,100,80,80,110];
