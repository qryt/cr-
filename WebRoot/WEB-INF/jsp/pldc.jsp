...
<div align="right"><IMG src="images\close.gif" alt="点击关闭层" width="13" height="13" style="cursor:hand" onclick="MM_showHideLayers('showdiv','','hide')">
 ...
 <form id="form1" method="post" action="list.htm?action=chkpldc">
...
<td width="10" align="center" class="main_menu_left">&nbsp;</td><td valign="top" style="padding-right:5px;"><table class="table_1"  width="100%"><tr><td background="images/menu_bg.png" style="color:#3965b5;height:20px;font-weight: bold;border-bottom:1px solid #D1DAE6;">&nbsp;&nbsp;批量堆存费处理</td></tr> <tr><td  style="padding:5px;"><fieldset style="width:100%;height:60px;border: 1 solid #3e7fd9"  ><legend>查询条件</legend>
...
<DIV id="nseer_grid_div"  align="right"><table><tr><td><input type="text" class="text" style="vertical-align:top" id="pldc" name="pldc" ondblclick="popUpCalendar(this, this, 'yyyy-mm-dd')" autocomplete="off" >&nbsp;&nbsp;<input type="button" onclick="plqr('pldc')" value="批量堆存确认"  onmouseover=this.className='btn3_mouseover' onmouseout=this.className='btn3_mouseout' onmousedown=this.className='btn3_mousedown' onmouseup=this.className='btn3_mouseup' class="SUBMIT_STYLE1">&nbsp;&nbsp;<input type="button" class="btn_2k3" onclick="plqx('pldc')" value="批量堆存取消"></td></tr></table></DIV>
 ...
 <script>
    ...
    reader: new Ext.data.ArrayReader({}, [
        ...
        var colM=new Ext.grid.ColumnModel([
            ...
            {header:'处理结果',dataIndex:'cljg',width:200,sortable:true}
        ]);
